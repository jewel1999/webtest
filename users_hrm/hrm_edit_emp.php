        ...
        $station = $_POST['station'];
                ...
                if(!isset($_SESSION['error'])){
                   ...
                   print_r($sql);
                    ...
                    header("location:hrm_page_emp.php");     
                }else {
...
<body>
  ...
  <div class="container mt-6"> 
        <div class="modal-body"> 
            <form action="hrm_edit_emp.php" method="post" enctype="multiplepart/form-data">
                <?php 
                    if(isset($_GET['id'])){
                        $id = $_GET['id'];
            ...
            <div class="mb-3">
                ...
                <input type="text" value="<?= $data['staff_id']?>" class="form-control" name="staff_id" readonly>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                    ...
                    <select  value="<?= $data['sex']?>" name="sex"  class="form-select" aria-label="Default select example" required >
           ...
           <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text"  value="<?= $data['usermail']?>" class="form-control" name="usermail" readonly >
            </div>
            ...
            <div class="mb-3">
                    ...
                    <select  value="<?= $data['status_staff']?>" name="status_staff"  class="form-select" aria-label="Default select example" required >
            ...
            <div class="mb-3">
                    ...
                    <select value="<?= $data['station']?>" name="station" class="form-select" aria-label="Default select example" required >
            ...
            <a type="button" class="btn btn-danger" href="hrm_page_emp.php">Close</a>
