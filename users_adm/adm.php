  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
        ...
        <li class="nav-item">
          <a class="nav-link" href="adm_page_emp.php">ข้อมูลพนักงาน</a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="adm_page_com.php">ข้อมูลคอมพิวเตอร์</a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="adm_page_printer.php">ข้อมูลเครื่องพิมพ์</a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="adm_page_other.php">ข้อมูลอุปกรณ์อื่นๆ</a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="adm_page_rn.php">ข้อมูลใบแจ้งซ่อม</a>
        </li>
