...
<body>
    <?php 
        if(isset($_SESSION['user_fin'])){
            $user_id= $_SESSION['user_fin'];
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-info">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="user_fin_emp.php">Employee information</a></li>
                    <li><a class="dropdown-item" href="user_fin_com.php">Computer information</a></li>
                    <li><a class="dropdown-item" href="user_fin_printer.php">Printer  information</a></li>
                    <li><a class="dropdown-item" href="user_fin_rn.php">Repair Notics</a></li>
                    <li><a class="dropdown-item" href="user_fin_other.php">Other</a></li>
