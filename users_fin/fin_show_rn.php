    ...
    if(isset($_POST['rn_update'])){
        ...
        $rn_des = $_POST['rn_des'];
                ...
                if(!isset($_SESSION['error'])){
                    ...
                    header("location:fin_page_rn.php");     
                }else {
...
<body>
            ...
            <a href="fin_page_rn.php" class="mt-4 btn btn-warning position-absolute top-0 start-50 translate-middle "> ย้อนกลับ </a>
